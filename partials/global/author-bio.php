...
<div class="author-info wpex-clr">
	<h4 class="heading"><span><?php printf( esc_html__( 'Written by %s', 'wpex-mesa' ), $author ); ?></span></h4>
		...
		<?php if ( wpex_author_has_social() ) : ?>
			<div class="author-social wpex-clr">
				...
				if ( $url = get_the_author_meta( 'wpex_googleplus', $post->post_author ) ) { ?>
					<a href="<?php echo esc_url( $url ); ?>" title="Google Plus" class="google-plus" target="_blank"><span class="fa fa-google-plus" aria-hidden="true"></span></a>
				<?php }
