	...
	<div class="wpex-socialbar wpex-clr">
		<?php foreach ( $social_options as $key => $val ) :
			...
			$target_blank = wpex_get_theme_mod( 'socialbar_target_blank' ) ? true : false; ?>
				<a href="<?php echo esc_url( $url ); ?>" title="<?php echo esc_attr( $val['label'] ); ?>"<?php wpex_target_blank( $target_blank ); ?>><span class="<?php echo esc_attr( $val['icon_class'] ); ?>" aria-hidden="true"></span></a>
			<?php endif; ?>
		<?php endforeach; ?>
	</div><!-- .wpex-socialbar -->
