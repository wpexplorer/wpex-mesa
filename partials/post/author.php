...
if ( $description = get_the_author_meta( 'description' ) ) : ?>
	...
	<section class="wpex-author-info wpex-clr">
		...
		<h4 class="wpex-heading" itemscope itemtype="http://schema.org/Person"><?php esc_html_e( 'Article written by', 'mesa' ); ?>: <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php esc_attr( esc_html_e( 'Visit Author Page', 'mesa' ) ); ?>"><span itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name"><?php echo strip_tags( get_the_author() ); ?></span></span></a></h4>

		<div class="wpex-author-info-inner wpex-clr">

			<div class="wpex-author-info-avatar">

				<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="<?php esc_attr( esc_html_e( 'Visit Author Page', 'mesa' ) ); ?>"><?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'wpex_author_bio_avatar_size', 70 ) ); ?></a>
